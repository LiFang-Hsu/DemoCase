    ...
    (function ($, undefined) {
        ...
        var Calendar = Widget.extend({
            ...
            _footer: function (template) {
                ...
                that._today = footer.show().find('.k-link').html(template(today)).attr('title', "民國" + kendo.formatTWDate(today, 'D', that.options.culture));
                that._toggle();
            },
            _header: function () {
            ...
            _templates: function () {
                ...
                that.footer = footer !== false ? template(footer || '#= "民國" + kendo.formatTWDate(data,"D","' + options.culture + '") #', { useWithBlock: false }) : null;
            }
        });
        ui.plugin(Calendar);
        var calendar = {
            ...
            views: [
                {
                    ...
                    title: function (date, min, max, culture) {
                        return "民國 " + (date.getFullYear() - 1911) + ' 年 ' + getCalendarInfo(culture).months.names[date.getMonth()];
                    },
                        ...
                        return view({
                            ...
                            build: function (date, idx, disableDates) {
                                ...
                                if (hasUrl && inArray(+date, dates)) {
                                    url = navigateUrl.replace('{0}', kendo.formatTWDate(date, format, culture));
                                ...
                                return {
                                    ...
                                    dates: dates,
                                    ns: kendo.ns,
                                    title: "民國" + kendo.formatTWDate(date, 'D', culture),
                                    value: date.getDate(),
                ...
                },
                {
                    name: 'year',
                    title: function (date) {
                        return "民國 " + (date.getFullYear() - 1911) + " 年";
                    },
                    content: function (options) {
                ...
                },
                {
                    ...
                    title: function (date, min, max) {
                        return "民國 " + title(date, min, max, 10) + " 年";
                    },
                    content: function (options) {
                ...
                },
                {
                    name: CENTURY,
                    title: function (date, min, max) {
                        return "民國 " + title(date, min, max, 100) + " 年";
                    },
                    content: function (options) {
                        ...
                        return view({
                            ...
                            setter: this.setDate,
                            build: function (date, idx) {
                                var start = (date.getFullYear() - 1911), end = start + 9;
                                if (start < min) {
                                    start = min;
                                }
                                if (end > max) {
        ...
        function title(date, min, max, modular) {
            var start = date.getFullYear() - 1911, minYear = min.getFullYear() - 1911, maxYear = max.getFullYear() - 1911, end;
